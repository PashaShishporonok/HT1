...
<head>
    ...
    <title>Управление информацией о номере телефона</title>
</head>
<body>
    ...
    <table align="center" border="1" width="70%">
        ...
        <tr>
            <td colspan="2" align="center">Информация о телефоне владельца:
                <i value="<%=person.getSurname()%>"></i>
                <i value="<%=person.getName()%>"></i>
                <i value="<%=person.getMiddlename()%>"></i>
            </td>
        </tr>
        <tr>
            <td>Номер:</td>
            <td><input type="text" name="telephone" value="<%=phonenumber%>"/></td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                <input type="submit" name="<%=jsp_parameters.get("next_action")%>" value="<%=jsp_parameters.get("next_action_label")%>" />
                <br>
                <a href="">Вернуться к данным о человеке</a>
            </td>
        </tr>
    </table>
</form>
